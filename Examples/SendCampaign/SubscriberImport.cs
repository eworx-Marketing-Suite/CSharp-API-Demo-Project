...
namespace SampleImplementation.Examples.SendCampaign {
    ...
    public class SubscriberImport {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriberImport"/> class.
        /// </summary>
        /// <param name="serviceAgent">Communicate with eMS</param>
        public SubscriberImport(EmsServiceAgent serviceAgent) {
        ...
        public KeyValuePair<Guid, List<Guid>> ImportSubscribers(string profileName) {
            ...
            // This action will take place after the subscribers have been imported to the eMS.
            ProfileAdderAction addToProfile = new ProfileAdderAction() {
                Name = profileName, // A new profile will be created if no profile does exist for the given name in the eMS.
        ...
        private Subscriber[] GetSubscribers() {
            ...
            // The status automatic inactive can only be set by the eMS system itself.
            ...
            subscriberDetailedExample.Fields = new Field[] {
                new TextField() { // A field with this internal name exists in every eMS account.
					InternalName = "email",
                ...
                new TextField { // A field of the type memo in eMS is also a textfield
					InternalName = "note",
